	...
	(function () {
	    ...
	    function AdminController(logger) {
	        ...
	        function activate() {
	            ...
	            __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./admin.style.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	        }
	    }
	})();
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    function DashboardController($q, dataservice, logger) {
	        ...
	        vm.news = {
	            title: 'hottowel',
	            description: 'aHot Towel Angular is a SPA template for Angular developers.'
	        };
	        vm.messageCount = 0;
	        vm.people = [];
	        vm.title = 'Dashboard';
